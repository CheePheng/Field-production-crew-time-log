        ...
        <div className="flex flex-col gap-3">
          {activities.length === 0 && (
            <div className="text-center py-12 px-4">
              ...
              <p className="text-base font-semibold text-gray-700">No activity types yet</p>
              <p className="text-sm text-gray-400 mt-1">Add your first activity type to begin logging work</p>
            </div>
          )}
